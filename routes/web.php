...
Route::group(['middleware' => 'auth'], function () {
  ...
  Route::group(['middleware' => 'Checkadmin'], function () {
    ...
    Route::get('/ProjectName', 'App\Http\Controllers\admindashboard\UseronboardController@ProjectName');
...
Route::get('proposalexpired',function(){
     return view('proposal_expired.index');
});
Route::get('reengage',function(){
  return view('proposal_expired.reengage');
});
Route::get('emailFormat',function(){
  return view('email.salesPersonSchedule');
});
