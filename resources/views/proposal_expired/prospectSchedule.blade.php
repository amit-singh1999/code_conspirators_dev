...
<div>
    ...
    <div><br>
        Now that you’ve made it official, you’ll receive your first invoice so we can get started. When payment is
        complete, your Strategist<b> {{ $strategist }} </b>
    ...
    <div><br>
        ...
        You’ll also be able to download a copy of the executed Service Agreement, or you can access it at the link
        below, so it doesn’t self-destruct:
