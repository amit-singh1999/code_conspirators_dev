    ...
    <table class="table divTable table-borderless">
        ...
        <tbody>
            ...
            <tr>
                ...
                <td class="spacer">{{$Valueofarray['invoicedate']}}</td>
                <td class="spacer"><?php $commission=  $Valueofarray['price']*$Valueofarray['commission']/100?>${{number_format($Valueofarray['price'],2,'.',',')}}</td>
                <td class="exspacer">${{number_format($commission,2,'.',',')}}</td>
            </tr>
            @endforeach
