<div>
    <div>Hi {{ $contactdata_Name }},&nbsp;</div>
    <div><br>

    </div>
    <div><br>
        A comment has been made on task "<strong>{{ $task_title}}</strong> by {{$commenter }}:<br>{{ $comment}}  
    </div>
    
    <div><br>
    
    
    Please login at <a href="https://portal-dev.codeconspirators.com/" target="_blank">https://portal-dev.codeconspirators.com/</a> for attachments.
