<div>
    <div>Hi {{$strategist_fname}}&nbsp;
    </div>
    <div><br>
        Attention!
    </div>
    <div><br>
    The last invoice (Invoice [#{{$InvoiceID}}]) for [{{$client_company_name]'s project [{{$project_name}}] is anticipated to be due on [{{invoice due date}}] in the amount of ${{ $InvoiceAmt}}. If the project is ready to launch, please send invoice manually.
