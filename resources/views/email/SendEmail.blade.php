...
<tr>
	<td>
		<p>Hi <? echo $name; ?>, thanks for being a Conspirator!&nbsp;&nbsp; </p>
	    <p>I'd like to introduce our CommandCenter, where you'll be able to access Mission Briefings, request Ground Support, and get other Top Secret info along the way.&nbsp;</p>
	    ...
	    <p style="margin-left:20px;">User: <? echo $email; ?><br>
	      Pass: <? echo $password ?>&nbsp;</p>
