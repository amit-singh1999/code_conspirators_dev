...
// echo $contactdata_Name;
// echo $existence_check;
//echo $pdflink;
?>

<div>
    <div>Hi <?php echo $contactdata_Name; ?>,&nbsp;</div>
    <div><br>

    </div>
    <div>We’re excited to conspire with you!</div>
    <div><br>
       Now that you’ve made it official, you’ll receive your first invoice so we can get started. When payment is complete, your Strategist<b> {{ $strategist }} </b>
       will reach out to schedule a meeting to Define the Mission.
    </div>
    <div><br>

        We’ve set up your access to Mission Control, where you’ll be able to engage with your team of Conspirators. 
        You’ll also be able to download a copy of the executed Service Agreement, or you can access it at the link below, so it doesn’t self-destruct:
        <a href="{{ $pdflink }}" target="_blank">Service Agreement</a>
