        ...
        <div class="row justify-content-center">
            <div class="col-lg-5 col-md-7">
                <div class="card bg-secondary shadow border-0">
                    <div class=" bg-transparent pb-5" style="padding:0 !important">
                        <div class="btn-wrapper text-center">
                            <img alt="Image placeholder" src="argon/img/brand/cc.png" style="margin:10px;width:75%;height:auto;">
                        </div>
                    </div>
                    <div class="card-body px-lg-5 py-lg-5">
                        <div class="text-center text-muted mb-4">
                            <small>
                                                                        Welcome to Code Conspirators!
                                    <br>
                                    Login below.
                            </small>
                        </div>
                        <form role="form" method="POST" action="{{ route('login') }}">
                            ...
                            <div class="text-center">
                                <button style="background:#c72027;border:unset;" type="submit" class="btn btn-success my-4">{{ __('Sign in') }}</button>
                            </div>
                        </form>
                    </div>
                </div>
