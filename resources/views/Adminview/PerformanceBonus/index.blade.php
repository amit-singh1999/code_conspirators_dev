...
@section('title', 'Performance Bonus Report')
<!-- Page Content  -->
@section('content')
...
<div id="content" class="p-4 p-md-5 pt-5">
    ...
    <div>
        ...
        <button type="submit" class="btn btn-success1" style="margin-left: 28px;" onclick="BonusTracking()">Generate
            Report
        </button>
        <button type="submit" class="btn btn-success1" style="margin-left: 28px;"
            onclick="DownloadPerformanceReport()">Download Report
        </button>
    </div>
                  ...
                  //  foreach ($newarr as $value) { ?>
                    ...
                    <tr>
                        <td scope="col" style="text-align:right">
                            <?php //echo $value->RESPONSIBLE_NAME." ".$value->RESPONSIBLE_LAST_NAME;  ?>
                        </td>
                        <td scope="col" style="text-align:right">$ <?php //echo $value->Commission?>
                        </td>
                        <td scope="col" style="text-align:right"><?php // echo $value->ID ?>
                        </td>
                        <td scope="col" style="text-align:right">$<?php //  echo $value->PRICE ?>
                        </td>
                    </tr>
