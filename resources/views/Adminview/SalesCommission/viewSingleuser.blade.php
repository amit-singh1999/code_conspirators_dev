...
<div id="content" class="p-4 p-md-5 pt-5">
 ...
 <?php $name ="" ; foreach ($mainarr as $value) { $name = $value['name']; }?>
 @section('title', $name)
        <div>
            <table class="table">
                ...
                <tbody class="table_body_color">
                   ...
                   // dd($mainarr);
                    ...
                    <td style='text-align:right'>$<?php $commission=  $value['price']*$value['commission']/100; echo number_format($commission,2,'.',',')?></td>
                    <td> <?php echo "</tr>"; ?>
                        <?php  } ?>
