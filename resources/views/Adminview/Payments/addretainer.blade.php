        ...
        <form action="{{ route('lineitem.save') }}" method="POST" enctype="multipart/form-data">
            ...
            <div class="row">
                ...
                <div class="col spacer">
                    <input type="text" class="form-control" name="companyname" data-userid="" id="Companyhere"
                        style="width:40%" placeholder="Please select Company">
                </div>
            </div>
            ...
            <div class="row">
                ...
                <div class="col spacer">
                    <select name="product_id" class="form-control select-checkbox" id="product_id" style="width:40%"
            ...
            <div class="row">
                ...
                <div class="col spacer">
                    <input type="number" class="form-control" name="quantity" id="justAnInputBox1" value="1"
                        style="width:40%">
                </div>
